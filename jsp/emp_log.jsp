...
<body>
	<h1><a href="<%= strPath %>/jsp/emp_log.jsp">出退勤ログ一覧画面</a>　　　ログインユーザー：<%= sName %></h1>


		<form class="formSearch" action="<%= strPath %>/servlet/sk31.Log_Search">
			...
			<a href="<%= strPath %>/jsp/emp_log.jsp" class="square_btn">ログ一覧画面へ</a>
